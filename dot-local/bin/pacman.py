...
# Define strings for user interface elements
my_input = "Enter your choice: "
my_line = "===================================="
my_choise = "    pacman - what do you want to perform?"
...
def show_menu():
    ...
    options = ["Update all",
               ...
               "Search new",
               "Show installed",
               "Write installed to text file",
               "Show explicitly installed pkg",
               "Show system installed pkg",
               "Show all inst. by size order",
               "Browse installed with descr.",
               "Remove orphans",
               "Menu",
               "Exit"]
    ...
    while True:
        ...
        if choice.isdigit() and 1 <= int(choice) <= 12:
            ...
            if choice == 1:
                ...
                os.system("sudo pacman -Qqtd") # Note: This command only *lists* orphans. A subsequent command like 'sudo pacman -Rns $(pacman -Qqtd)' would remove them. The original script only lists them with 'pacman -Qqtd'.
            elif choice == 11:
                show_menu()
            elif choice == 12:
                exit(1)
