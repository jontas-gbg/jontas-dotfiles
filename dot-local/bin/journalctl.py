    ...
    while True:
        ...
        if choice.isdigit() and 1 <= int(choice) <= 8:
            ...
            if choice == 1:
                ...
                os.system("echo -e '\n --- VISAR 15 KONTROLL AV REPO FÖR UPPDATERINGAR ---\n' && journalctl --user -u check_updates.service -r -n 15")
            elif choice == 6:
            ...
            print("Ogiltigt val. Ange en siffra mellan 1 och 7.")
